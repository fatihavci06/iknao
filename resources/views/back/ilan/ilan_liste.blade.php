...
@section('content')
    ...
    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a94b6098-69ef-46e2-9640-f708f9cc7651" id="dom-a94b6098-69ef-46e2-9640-f708f9cc7651">
    ...
    <script>
        $(function() {
            $('.fs--1').DataTable({
                ...
                columns: [
                    { data: 'id', name: 'id' },//yukarıda routtan çektiğimiz dataları burada tabloya sıra sıra yazdırdık. ancak datatablede burada data kdar sutun olmalı
                    { data: 'name', name: 'name' },
