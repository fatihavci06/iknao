            ...
            <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
                <section class="py-3  ">
                    ...
                    <div class="container ">
                        ...
                        @endif
                        <form id="progress-form" class="p-4 progress-form" action="{{route('gozlem.girpost')}}" enctype="multipart/form-data"  method="post" lang="en" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="yonetici" id="yonetici" readonly value="{{Auth::guard('yonetim')->user()->firstname}} {{Auth::guard('yonetim')->user()->lastname}}" >
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="ders" name="ders" >
                                                <option value="">Seçiniz</option>
                                                @foreach($ders as $d)
                                                    <option value="{{$d->id}}">{{$d->ders_name}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sube" name="sube" >
                                                <option value="">Seçiniz</option>
                                                @foreach($sube as $s)
                                                    <option value="{{$s->id}}">{{$s->sube_name}}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="ders_konu" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" size="1" type="text" name="goztur" id="goztur" data-rule-required="true" >
                                                <option value="" selected="">ZORUNLU SEÇİNİZ...</option>
                                                <option value="İZLEME">DERS İZLEME (OKUL YÖNETİCİSİ)</option>
                                                <option value="GELİŞİMSEL">YAPILANDIRMACI GÖZLEM ( MESLEKİ GELİŞİM UZMANI) </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section id="progress-form__panel-2" style="margin-top: -50px;" role="tabpanel" aria-labelledby="progress-form__tab-2" tabindex="0" hidden>
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        ...
                                        <div class="min-vh-30">
                                            <textarea  class="tinymce d-none" id="gozlemnotu" name="gozlemnotu">{{old('description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row  ">
                                    <table class="table table-bordered table-condensed">
                                        <tbody><tr style="background:#fff8d3;">
                                            ...
                                            <td width="34%"><center>Ek Notlar</center>
                                            </td>
                                        </tr><tr>
                                            <td><h5>Derse zamanında girildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k1" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k1" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k1" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k1" value="0" style="margin-left: -9px;" checked=""></div>
                                                </div>
                                            </td><td rowspan="8">
                                                <textarea  class="tinymce d-none" id="description" rows="20" name="aciklama1">{{old('aciklama1')}}</textarea>
                                            </td></tr><tr>
                                            <td><h5>Öğretmen kılık-kıyafeti ve görünümü yönergeye uygundu.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k2" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k2" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k2" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k2" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>İşlenen ders portal planına uygundu.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k3" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k3" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k3" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k3" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Sınıf düzeni sağlandı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k4" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k4" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k4" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k4" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Sınıf yoklaması alındı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k5" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k5" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k5" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k5" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Derste kullanılacak materyal/sunum hazırlandı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k6" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k6" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k6" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k6" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Dersin içeriği hakkında öğrenci bilgilendirildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k7" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k7" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k7" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k7" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Bir önceki derste işlenilen kazanım hatırlatıldı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b1k8" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k8" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k8" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b1k8" value="0" checked=""></div>
                                                </div>
                                            </td></tr></tbody></table>
                                ...
                                <section id="progress-form__panel-4" style="margin-top: -50px;" role="tabpanel" aria-labelledby="progress-form__tab-4" tabindex="0" hidden>
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        <tbody><tr style="background:#fff8d3;">
                                            ...
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k1" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k1" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k1" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k1" value="0" checked=""></div>
                                                </div>
                                            </td><td rowspan="13"> <textarea  class="tinymce d-none" id="aciklama2" name="aciklama2">{{old('aciklama3')}}</textarea></td></tr><tr>
                                            <td><h5>Konuya hakim ve güven veren bir  öğretmen izlenimi verildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k2" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k2" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k2" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k2" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Öğrenciler derse katılmaya teşvik edildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k3" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k3" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k3" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k3" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Ders anlatımı sırasında güncel örnekler verildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k4" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k4" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k4" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k4" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Eksik ve yanlış cevaplar zamanında ve uygun şekilde düzeltildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k5" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k5" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k5" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k5" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Tüm öğrenciler motive edilerek derse aktif katılımları sağlandı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k6" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k6" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k6" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k6" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Öğrencinin not tutması sağlandı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k7" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k7" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k7" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k7" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Zaman etkili ve verimli kullanıldı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k8" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k8" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k8" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k8" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Akran öğrenmesi (ikili çalışma, takım çalışması vb.) için olanak sağlandı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k9" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k9" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k9" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k9" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Ders sırasında veya sonunda özet yapıldı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k10" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k10" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k10" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k10" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Ders sonunda değerlendirme yapıldı.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k11" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k11" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k11" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k11" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Ders sonunda bir sonraki dersle ilgili bilgi verildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k12" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k12" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k12" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k12" value="0" checked=""></div>
                                                </div>
                                            </td></tr><tr>
                                            <td><h5>Bir sonraki ders için ödev verildi.</h5></td>
                                            <td>
                                                <div class="row text-center">
                                                    <div class="col-md-3"><input type="radio" name="b2k13" value="3"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k13" value="2"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k13" value="1"></div>
                                                    <div class="col-md-3"><input type="radio" name="b2k13" value="0" checked=""></div>
                                                </div>
                                            </td></tr></tbody></table>
                            ...
                            <section id="progress-form__panel-5" style="margin-top: -50px;" role="tabpanel" aria-labelledby="progress-form__tab-5" tabindex="0" hidden>
                                <table class="table table-bordered table-condensed">
                                    <tbody><tr style="background:#fff8d3;">
                                        ...
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k1" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k1" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k1" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k1" value="0"  checked=""></div>
                                            </div>
                                        </td><td rowspan="8"> <textarea  class="tinymce d-none" id="aciklama3" name="aciklama3">{{old('aciklama3')}}</textarea></td></tr><tr>
                                        <td><h5>Ses tonu ve beden dili etkili şekilde kullanıldı.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k2" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k2" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k2" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k2" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td><h5>Öğrencilerle etkili göz iletişimi kuruldu.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k3" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k3" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k3" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k3" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td><h5>Ders süresince sınıfta olumlu bir sınıf iklimi yaratıldı.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k4" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k4" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k4" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k4" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td><h5>Uygun olmayan davranışlara zamanında müdahale edildi.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k5" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k5" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k5" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k5" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td><h5>Öğrencilerin ilgi ve çabaları takdir edildi.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k6" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k6" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k6" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k6" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td><h5>Öğrenciler ilgi ve sabırla dinlendi.</h5></td>
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-md-3"><input type="radio" name="b3k7" value="3"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k7" value="2"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k7" value="1"></div>
                                                <div class="col-md-3"><input type="radio" name="b3k7" value="0" checked=""></div>
                                            </div>
                                        </td></tr><tr>
                                        <td width="30%"></td>
                                        <td>
