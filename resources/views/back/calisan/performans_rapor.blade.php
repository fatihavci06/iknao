                ...
                <div class="card-header">
                    <div class="row flex-between-end">
                        <div class="col-auto align-self-center">
                            <h5 class="mb-0" data-anchor="data-anchor" id="jquery-datatables-default-example">{{$data[0]->firstname}} &nbsp {{$data[0]->lastname}} Mülakat Listesi <a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#jquery-datatables-default-example" style="padding-left: 0.375em;"></a></h5>
                        </div>
                            ...
                            <div id="tableExample3" style="margin-bottom: 30px;" data-list='{"valueNames":["name","email"],"page":5,"pagination":true}'>
                                ...
                                <div class="table-responsive scrollbar">
                                    <table class="table table-bordered table-striped fs--1 mb-0">
                                        ...
                                        @foreach($data as $d)
                                        <tr>
                                            <td class="name">{{$d->mulakat_tur}}</td>
                                            <td class="email"><a href="{{route('performans.edit',['id'=>$d->pid])}}" class="btn btn-sm btn-primary">Düzenle</a>
                                                <a href="{{route('performans.sil',['id'=>$d->pid])}}" class="btn btn-sm btn-warning" onclick="return confirmDel()">Sil</a>
