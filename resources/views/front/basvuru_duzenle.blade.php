            ...
            <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
                <section class="py-3 bg-light shadow-sm ">
                    ...
                    <div class="container mt-5">
                        ...
                        <form id="progress-form" class="p-4 progress-form"  enctype="multipart/form-data" action="{{route('front.update')}}" method="post" lang="en" novalidate>
                            @csrf
                            @if(session('success'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="container form__field">
                                                ...
                                                <input type="file" accept="image/png, image/jpeg" style="line-height: 24px!important;font-size: 16px;" name="avatar" id="avatar" class="form-control" autocomplete="given-name"  >
                                            </div>
                                            <div class="container mt-4 form__field">
                                                <label for="tc">Tc Kimlik Numarası</label>
                                                <input type="number" value="{{$data->tc}}" name="tc" id="tc" class="form-control" autocomplete="given-name" min="1" max="9"  required>
                                            </div>
                                            <div class="container mt-4 form__field">
                                ...
                                <div class=" mt-4">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="container form__field">
                                            ...
                                            <input type="number" id="cepno" name="cepno" value="{{$data->cepno}}" class="form-control" required>
                                        </div>
