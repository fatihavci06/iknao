                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    ...
                                    <p class="fs-0 text-600">- Scott Tolinski, Web Developer</p><img class="w-auto mx-auto" src="{{asset('tema/public/')}}/assets/img/logos/google.png" alt="" height="45" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    ...
                                    <p class="fs-0 text-600">- Jeff Escalante, Developer</p><img class="w-auto mx-auto" src="{{asset('tema/public/')}}/assets/img/logos/netflix.png" alt="" height="30" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    ...
                                    <p class="fs-0 text-600">- Liam Martens, Designer</p><img class="w-auto mx-auto" src="{{asset('tema/public/')}}/assets/img/logos/paypal.png" alt="" height="45" />
                                </div>
                            </div>
                        </div>
